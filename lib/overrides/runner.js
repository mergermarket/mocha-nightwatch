...
var Nightwatch = require('../nightwatch/client');
...
Runner.prototype.run = function(nwSettings, fn) {
  var self = this;
  var rootSuite = this.suite;
  var nightwatch = new Nightwatch(this, nwSettings);
  ...
  function setClient(test) {
    test.setNightwatchClient(nightwatch.getClient());
  }
